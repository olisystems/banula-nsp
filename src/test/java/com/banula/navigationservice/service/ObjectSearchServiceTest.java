...
class ObjectSearchServiceTest {
 @Test void combinesLiteralFiltersBeforeCountingAndPaging() {
  ...
  when(collections.getSmartLocationCollectionName()).thenReturn("objects");
  ...
  var result = service.search("locations", "a.*", "station", "de", "oli", null, null, 10, 10);
 ...
 @Test void rejectsInvalidFiltersWithoutQueryingMongo() {
  ...
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null,null,null,null,null,null,-1,10));
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null,null,null,null,null,null,0,201));
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null,null,"Germany",null,null,null,0,10));
 ...
 @Test void keepsUtcBoundsAndModuleFieldSelectionIndependentOfHostTimezone() {
  ...
  try {
   ...
   for (String module : List.of("locations")) {
    MongoTemplate mongo = mock(MongoTemplate.class);
    MongoCollectionMapper collections = mock(MongoCollectionMapper.class);
    when(collections.getSmartLocationCollectionName()).thenReturn("objects");
