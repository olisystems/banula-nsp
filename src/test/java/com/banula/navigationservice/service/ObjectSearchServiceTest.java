...
class ObjectSearchServiceTest {
 @Test void combinesLiteralFiltersBeforeCountingAndPaging() {
  ...
  var result = service.search("locations", null, "a.*", "station", "de", "oli", null, null, 10, 10);
 ...
 @Test void rejectsInvalidFiltersWithoutQueryingMongo() {
  ...
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null, null,null,null,null,null,null,-1,10));
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null, null,null,null,null,null,null,0,201));
  assertThrows(ResponseStatusException.class, () -> service.search("locations", null, null,null,"Germany",null,null,null,0,10));
