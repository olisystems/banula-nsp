...
class ObjectSearchServiceTest {
    ...
    void rejectsInvalidFiltersWithoutQueryingMongo() {
        ...
        assertThrows(
                ...
                () ->
                        service.search(
                                "locations",
                                SearchCriteria.builder().offset(-1).limit(10).build()));
        assertThrows(
                ResponseStatusException.class,
                () ->
                        service.search(
                                "locations",
                                SearchCriteria.builder().offset(0).limit(201).build()));
        assertThrows(
                ResponseStatusException.class,
                () ->
                        service.search(
    ...
    @org.junit.jupiter.params.provider.ValueSource(strings = {"locations"})
